        ...
        <div className="bg-white rounded-2xl shadow-sm p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5 text-sm">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-5 top-1/2 -translate-y-1/2 text-slate-600 hover:text-slate-800 cursor-pointer"
                >
                  {showPassword ? (
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2.5 px-4 bg-linear-to-r from-red-600 to-red-500 text-white rounded-full text-sm transition-all disabled:opacity-60 flex items-center justify-center gap-2 cursor-pointer"
            >
              {loading ? (
                "Signing in..."
              ) : (
