          ...
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl border border-slate-100 overflow-hidden flex flex-col max-h-[90vh]">
            ...
            <div className="p-8 bg-slate-50/50 border-t border-slate-50 space-y-8">
                    ...
                    {PLATFORMS.map((p) => {
                      ...
                      return (
                        <button
                          ...
                          className={`p-2.5 rounded-md border text-xs cursor-pointer ${active ? "bg-red-500/80 text-white" : "bg-white border-slate-300 text-slate-700 hover:border-slate-500"}`}
                        >
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 py-3 rounded-md bg-slate-200 text-slate-700 hover:bg-red-500 hover:text-white transition cursor-pointer"
              >
                {scheduling ? (
                  <Loader2Icon className="size-4 animate-spin" />
                ) : (
