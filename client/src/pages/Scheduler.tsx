        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-6">
          ...
          <form className="space-y-5" onSubmit={handleSchedule}>
            ...
            <div className="">
              ...
              />
              <div
                className={`text-right text-xs mt-1 font-medium ${content.length > 290 ? "text-red-500" : "text-slate-400"}`}
              >
                {content.length}/300
              </div>
            </div>
            ...
            <div className="">
              ...
              {mediaFile ? (
                ...
                <label className="flex items-center justify-center gap-2 p-5 border-2 border-dashed border-slate-300 rounded-xl cursor-pointer hover:border-red-300 hover:bg-red-50/30 transition-all group">
